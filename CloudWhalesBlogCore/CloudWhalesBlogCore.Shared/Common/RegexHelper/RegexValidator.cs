/*****************************************************************************
*项目名称:CloudWhalesBlogCore.Shared.Common.Regex
*项目描述:
*类 名 称:RegexValidator
*类 描 述:
*创 建 人:Chuanmingxie
*创建时间:2022/5/9 8:22:52
*修 改 人:
*修改时间:
*作用描述:<FUNCTION>
...
namespace CloudWhalesBlogCore.Shared.Common.RegexHelper
{
    public class RegexValidator
    {
        ...
        /// <returns>是否匹配</returns>
        public static bool IsMatchWhiteSpace(string inputStr, string patternStr, bool ifValidateWhiteSpace)
        {
