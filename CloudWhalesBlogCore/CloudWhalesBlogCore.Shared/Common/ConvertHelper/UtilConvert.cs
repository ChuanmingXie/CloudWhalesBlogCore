/*****************************************************************************
*项目名称:CloudWhalesBlogCore.Shared.Common.ConvertHelper
*项目描述:
*类 名 称:UtilConvert
*类 描 述:
*创 建 人:Chuanmingxie
*创建时间:2022/5/26 15:26:36
*修 改 人:
*修改时间:
*作用描述:<FUNCTION>
...
namespace CloudWhalesBlogCore.Shared.Common.ConvertHelper
{
    public static class UtilConvert
    {
        ...
        {
            return ObjectToString(thisValue) != "" && ObjectToString(thisValue) != "undefined" && ObjectToString(thisValue) != "null";
        }
        /// <summary>
        /// 
        /// </summary>
