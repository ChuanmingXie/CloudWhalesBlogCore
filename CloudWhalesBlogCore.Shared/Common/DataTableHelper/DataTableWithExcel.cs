/*****************************************************************************
*项目名称:CloudWhalesBlogCore.Shared.Common.DataTableHelper
*项目描述:
*类 名 称:DataTableWithExcel
*类 描 述:
*创 建 人:Chuanmingxie
*创建时间:2022/5/9 8:04:51
*修 改 人:
*修改时间:
*作用描述:<FUNCTION>
...
namespace CloudWhalesBlogCore.Shared.Common.DataTableHelper
{
    public class DataTableWithExcel:BaseDisposable
    {
        ...
        public DataTableWithExcel(string fileName)
        {
