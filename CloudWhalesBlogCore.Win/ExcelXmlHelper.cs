...
{
    public class ExcelXmlHelper: DisposableClass
    {
        ...
        public List<Tuple<int, int, string, string, string>> XMLPhotoList()
        {
            try
            {
                SharpCompressHelper.DeCompressionFile(ExcelPath, RootPath);
                ...
                {
                    photoList.AddRange(FindPhotoCell(photoPiar));
                }
